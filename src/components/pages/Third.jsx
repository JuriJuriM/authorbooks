        ...
        <div className='third'>
            <div className="container">
                ...
                <div className="third__row">
                    ...
                    <div className="third__column">
                        <div className="third__item">
                            <div className="third__text">Если порыться в мировой литературе, в том числе и специальной, то, без всякого сомнения, можно обнаружить тот факт, что про банки и банковскую систему написаны бесчисленные труды, в том числе и экономические с их скрупулёзными расчётами, числовыми графиками и таблицами.</div>
                        </div>
                    </div>
                </div>
                <div className="third__row">
                        ...
                        <div className="third__items">
                            <div className="third__textall">
                                ...
                                <div className="third__button">
                                    <a href="https://ridero.ru/books/bankomat/">В магазин</a>
                                </div>
