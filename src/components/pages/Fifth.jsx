            ...
            <div className="container">
                <div className="fifth__body">
                    ...
                    <div className="fifth__row">
                        ...
                        <div className="fifth__column">
                            <div className="fifth__item">
                                <div className="fifth__text">«Мы из СВУ» — роман, название которого говорит само за себя. В книге просто и доходчиво рассказывается о людях, которые прошли эту школу. Книга будет интересна тем, кто учился в Суворовском военном училище, и тем, кто ещё только собирается её пройти.</div>
                            </div>
                        </div>
                    </div>
